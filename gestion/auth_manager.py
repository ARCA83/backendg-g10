...
#BaseUserManager > sirve para modifcar la creacion y administracion de los auth_user

class UsuarioManager(BaseUserManager):
    #esta clase me permitira modificar la administrcion del usuario mediante el comando createsuperuser
    def create_superuser(self, correo, nombre, apellido, tipoUsuario, password):
        ...
        #removera los espacios al inicio y al final validara que no se utilice incorrectos
